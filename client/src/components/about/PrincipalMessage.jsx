      ...
      <div className="bg-white rounded-2xl overflow-hidden border border-outline-variant flex flex-col md:flex-row shadow-sm">
        <div className="md:w-2/5 lg:w-1/3 min-h-[320px] relative">
          <img
            ...
            alt="Dr. S. K. Mukherjee, Principal"
          ...
          <div className="absolute bottom-4 left-4 text-white md:hidden">
            <span className="text-xs uppercase font-bold text-secondary-fixed">Principal</span>
            <h4 className="font-bold text-lg">Dr. S. K. Mukherjee</h4>
          </div>
        </div>
        ...
        <div className="md:w-3/5 lg:w-2/3 p-8 sm:p-10 lg:p-12 flex flex-col justify-center">
          ...
          <blockquote className="font-body-md text-base sm:text-lg text-on-surface-variant italic mb-6 border-l-4 border-secondary-fixed pl-4 bg-surface-container-low/50 py-2 rounded-r-lg">
            "Education is not merely the accumulation of facts, but the conscious training of the mind to think critically, act ethically, and contribute meaningfully to society."
          </blockquote>
          <p className="font-body-md text-base text-on-surface-variant mb-6 leading-relaxed">
            With over 25 years of academic and administrative leadership in West Bengal's secondary education ecosystem, Dr. Mukherjee has spearheaded state-level digital learning paradigms and vocational enrichment programs. Under his stewardship, Durgapur High School continues its legacy of 100% board results and student-centered growth.
          </p>
          <div className="flex flex-wrap gap-3">
            ...
            <div className="bg-surface-container-high px-4 py-2 rounded-lg text-primary font-bold font-label-md text-xs sm:text-sm">
              Former State Advisory Panel Member
            </div>
            <div className="bg-surface-container-high px-4 py-2 rounded-lg text-primary font-bold font-label-md text-xs sm:text-sm">
              President's Gold Medal Nominee
            </div>
          </div>
        </div>
      </div>
